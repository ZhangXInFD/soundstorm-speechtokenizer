...
# Tokens file
train_file_list = '/remote-home/xzhang/Speech/soundstorm-speechtokenizer/train_file_list_tokens.txt'
with open(train_file_list, 'r') as f:
    train_file_list = f.readlines()
valid_file_list = '/remote-home/xzhang/Speech/soundstorm-speechtokenizer/valid_file_list_tokens.txt'
with open(valid_file_list, 'r') as f:
    valid_file_list = f.readlines()

result_folder = './ls_result_tokens'
